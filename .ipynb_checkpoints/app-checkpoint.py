...
def analyze_textual_difference_with_gpt(image_name, user_description, reference_description, retries=5, wait_time=20):
    prompt = (
        ...
        f"2. **List missing elements**: Identify elements that are present in the reference data but absent in the user's description (excluding healthy teeth).\n"
        f"3. **Confirm correct elements**: Indicate elements that match exactly between the user's description and the reference data.\n"
