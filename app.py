...
def analyze_textual_difference_with_gpt(image_name, user_description, reference_description, retries=5, wait_time=20):
    ...
    f"Format your response as a list with clear and concise bullet points, using full terms. Provide constructive feedback and avoid directly revealing the reference ata."
)
